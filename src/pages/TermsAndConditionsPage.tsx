  ...
  return (
    <div className="flex flex-col gap-6 w-full px-6 sm:px-12 max-w-screen-lg">
      ...
      <section className="flex flex-col gap-3">
        <p>
          This is a fake e-commerce website, built solely as a web development
          portfolio project. THIS IS NOT A REAL STORE. The page below contains
          some boilerplate terms and conditions I found in a terms and
          conditions generator.
        </p>

        <p>
          These terms and conditions govern the use of infinitebliss.com. This
      ...
      <section>
        <h2 className="font-semibold uppercase">Intellectual Property</h2>
        <p>
          All content published and made available on our site is the property
          of Robert Kelley and the site's creators. This includes, but is not
      ...
      <section>
        <h2 className="font-semibold uppercase">Accounts</h2>
        <div className="flex flex-col gap-3">
          ...
          <p>
            ...
            information attached to that account; and All personal information
            you provide to us through your account is up to date, accurate, and
            truthful and that you will update your personal information if it
            changes. We reserve the right to suspend or terminate your account
            if you are using our site illegally or if you violate these terms
            and conditions.
          </p>
        </div>
      </section>
      ...
      <section>
        <h2 className="font-semibold uppercase">Sale of Goods</h2>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>
            These terms and conditions apply to all the goods that are displayed
            on our site at the time you access it. This includes all products
            listed as being out of stock. All information, descriptions, or
            images that we provide about our goods are as accurate as possible.
            However, we are not legally bound by such information, descriptions,
            or images as we cannot guarantee the accuracy of all goods we
            provide. You agree to purchase goods from our site at your own risk.
          </p>
      ...
      <section>
        <h2 className="font-semibold uppercase">Payments</h2>
      ...
      <section>
        <h2 className="font-semibold uppercase">Shipping and Delivery</h2>

        <div className="flex flex-col gap-3">
          <p>
            When you purchase goods from our site, the goods will be delivered
            through one of the following methods:
          </p>

          <ul>
            <li>
              Standard delivery by mail. Delivery takes 5 - 7 business days.
            </li>
          </ul>

          <p>
            Delivery will take place as soon as reasonably possible, depending
            on the delivery method selected. Delivery times may vary due to
            unforseen circumstances. Please note that delivery times do not
            include weekends and statutory holidays.
          </p>

          <p>
            You will be required to pay delivery charges in addition to the
            price for the goods you purchase.
          </p>

          <p>
            You are required to provide us with a complete and accurate delivery
            address, including the name of the recipient. We are not liable for
            the delivery of your goods to the wrong address or wrong person as a
            result of you providing us with inaccurate or incomplete
            information.
          </p>
        </div>
      </section>
      ...
      <section>
        <h2 className="font-semibold uppercase">Consumer Protection Law</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold uppercase">Limitation of Liability</h2>
        <p>
          Robert Kelley and our directors, officers, agents, employees,
      ...
      <section>
        <h2 className="font-semibold uppercase">Indemnity</h2>
        <p>
          Except where prohibited by law, by using this site you indemnify and
          hold harmless Robert Kelley and our directors, officers, agents,
      ...
      <section>
        <h2 className="font-semibold uppercase">Applicable Law</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold uppercase">Dispute Resolution</h2>
        <div className="flex flex-col gap-3">
          <p>
            Subject to any exceptions specified in these terms and conditions,
            if you and Robert Kelley are unable to resolve any dispute through
            informal discussion, then you and Robert Kelley agree to submit the
            issue first before a non-binding mediator and to an arbitrator in
            the event that mediation fails. The decision of the arbitrator will
            be final and binding. Any mediator or arbitrator must be a neutral
            party acceptable to both you and Robert Kelley. The costs of any
            mediation or arbitration will be shared equally between you and
            Robert Kelley.
          </p>

          <p>
            Notwithstanding any other provision in these terms and conditions,
            you and Robert Kelley agree that you both retain the right to bring
            an action in small claims court and to bring an action for
      ...
      <section>
        <h2 className="font-semibold uppercase">Severability</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold uppercase">Changes</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold uppercase">Contact Details</h2>
        <div className="flex flex-col gap-3">
