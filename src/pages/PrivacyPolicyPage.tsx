    ...
    <main className="flex flex-col gap-6 w-full px-6 sm:px-12">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p>
          ...
          anyone decided to use our Service, the Blood Incantation website.
        </p>
      ...
      <section>
        <h2 className="uppercase font-semibold">Service Providers</h2>
        <div className="flex flex-col gap-3">
          <p>
      ...
      <section>
        <h2 className="uppercase font-semibold">Security</h2>
      ...
      <section>
        <h2 className="uppercase font-semibold">Links to Other Sites</h2>
